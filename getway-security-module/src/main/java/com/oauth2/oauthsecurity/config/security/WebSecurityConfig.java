...
////        每个配置项使用and进行连接 //        禁止匿名访问 //        结局frame不显示的问题
...
////                采用持久化的方式实现token 记住我
//                .and().rememberMe().tokenValiditySeconds(86400).tokenRepository(persistentTokenRepository())
//                .userDetailsService(springSecurityUser)
