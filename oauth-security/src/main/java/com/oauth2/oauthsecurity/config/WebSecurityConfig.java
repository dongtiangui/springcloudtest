...
import com.oauth2.oauthsecurity.filter.JWTLoginFilter;
import com.oauth2.oauthsecurity.filter.JwtAuthenticationFilter;
import com.oauth2.oauthsecurity.security.SpringSecurityUser;
...
//                对所以 / index home.html 不用认证即可授权
                .antMatchers("/oauth/**","/member/**","/api/**","/login/**", "/logout").permitAll()
